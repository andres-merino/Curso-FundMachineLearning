...
\begin{center}\color{azul}
    \qrcode[height=5.5cm]{https://linktr.ee/aemerinot}
    \\[5mm]
    Cuaderno de Jupyter
\end{center}
\end{frame}
...
\begin{center}
    ...
    \phantom{.\hspace{.5cm}.}
    &
    \colorbox{white}{\textcolor{azul}{\qrcode[height=3cm]{https://github.com/andres-merino/Curso-FundMachineLearning/blob/main/1-Webinar/Webinar.ipynb}}}
    \\[16mm]
