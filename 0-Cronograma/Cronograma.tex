...
1	&	1	&	18-feb	&	Conceptos básicos del Aprendizaje Automático \\	
	&	2	&	19-feb	&	Preparación de datos: normalización y PCA	\\	
	&	3	&	20-feb	&	Conjuntos de entrenamiento y prueba; validación cruzada	\\	\midrule	
2	&	4	&	23-feb	&	Aprendizaje no supervisado: métricas e interpretación \\	
	&	5	&	24-feb	&	Agrupamiento k-Means y Clustering jerárquico	\\ 
	&	6	&	25-feb	&	Aprendizaje supervisado: métricas y k-NN	\\	
	&	7	&	26-feb	&	SVM	y Árboles de decisión\\	
	&	8	&	27-feb	&	Redes neuronales: perceptrón y perceptrón multicapa	\\	\midrule	
3	&	9	&	02-mar	&	Ensamble de modelos	\\	
	&	10	&	03-mar	&	Optimización de hiperparámetros y guardado de modelos	\\	
\end{longtable}
\end{center}
