...
En el transcurso del curso se presentarán \href{8 (ocho) ejercicios simples}, elaborados en cuadernos de Jupyter, que cada asistente deberá desarrollar con un conjunto de datos a elección.

Para la aprobación del curso, se debera presentar 5 (cinco) de los 8 (ocho) ejercicios. Estos deben ser enviados en foramto PDF al correo aemerinot@gmail.com con el asunto: «Actividad Fund. Machine Learning - Marzo 2026»; en el mensaje se debe indicar el nombre completo. La fecha máxima de envío será el domingo 15 de marzo de 2026.
