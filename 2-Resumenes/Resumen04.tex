...
\begin{itemize}
    ...
    \]
    \item \textbf{Cohesión de Silueta:} Mide la distancia promedio entre un punto y todos los demás puntos en el mismo clúster, para $x \in C_i$
    \[
    ...
    \]
    \item \textbf{Separación de Silueta:} Mide la distancia promedio entre un punto y todos los puntos en el clúster más cercano al que no pertenece, para $x\in C_i$
    \[
