...
\usecolortheme{orchid}
    ...
    \setbeamercolor{date}{fg=azul}
    \setbeamerfont{date}{series=\bfseries}
    \setbeamercolor{institute}{fg=azul}
    \setbeamerfont{institute}{series=\bfseries}
    % -- Barra de progreso
    \setbeamercolor{progress bar}{bg=azul, fg=azul}
    % -- Linea de separación en la página de título
    \makeatletter
    \setbeamertemplate{title separator}{
        \begin{tikzpicture}
            \fill[azul] (0,0) rectangle (0.8\textwidth, \metropolis@titleseparator@linewidth);
        \end{tikzpicture}%
        \par%
    }
    \makeatother
    ...
    \addtobeamertemplate{frametitle}{\vspace*{-8mm}}{\vspace*{-3mm}}
